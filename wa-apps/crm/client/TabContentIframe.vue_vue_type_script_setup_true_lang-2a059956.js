import{d as h,h as a,af as v,bF as y,B as o,o as n,c as r,p as b,j as d,k as _,v as j,n as g,aa as k,F as B,a as $}from"./main-925f5bcf.js";import{u as O}from"./iframeObserver-e018589a.js";const q={key:0},x={key:1,class:"tw-absolute tw-top-1/2 tw-left-1/2 -tw-translate-x-1/2 -tw-translate-y-1/2"},C=$("div",{class:"spinner custom-p-16"},null,-1),E=[C],F=["srcdoc"],U=h({__name:"TabContentIframe",props:{tab:{},forceResize:{type:Boolean},style:{},contentOutsideTabBody:{type:Boolean}},setup(w){const e=w,m=a(),c=a(""),l=a(""),i=a("url"in e.tab),u=a("html"in e.tab);O(m,!1,e.forceResize),e.contentOutsideTabBody?f():v(f);async function f(){if("url"in e.tab){i.value=!0;const t=await y(e.tab.url).get().text();l.value=t.error.value,i.value=!1,t.data.value&&p(t.data.value)}else p(e.tab.html)}function p(t){if(typeof t!="string")throw new Error("content not parse string");const s=`
    <!DOCTYPE html>
