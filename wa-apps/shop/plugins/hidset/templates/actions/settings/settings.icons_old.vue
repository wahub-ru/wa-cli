...
<template v-if="liFree==='icons' && li==='free'">
    <action-button @click="saveSettings('icons')" title="[`Сохранить`]" icon="icon16 disk" :run="runActions" style="margin-bottom: 20px;"></action-button>
    <action-button @click="restoreDefaultSettings('icons')" title="Восстановить значения по-умолчанию" icon="icon16 update" :run="false"></action-button>
