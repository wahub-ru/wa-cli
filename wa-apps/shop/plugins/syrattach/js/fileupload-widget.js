...
(function ($) {
    'use strict';
    $.product_syrattachments.widget_options =  {
...
//                $("#upload-error").hide();
        ...
        _startHandler: function (e) {
            e.preventDefault();
            var button = $(this),
                tmpl = button.closest('.s-plugin-syrattach-template-upload'),
                data = tmpl.data('data');
        ...
        _cancelHandler: function (e) {
            e.preventDefault();
            var tmpl = $(this).closest('.s-plugin-syrattach-template-upload'),
                data = tmpl.data('data') || {};
            if (!data.jqXHR) {
        ...
        _deleteHandler: function (e) {
            ...
            e.data.fileupload._trigger('destroy', e, {
                context: button.closest('.s-plugin-syrattach-template-download'),
        ...
        _initTemplates: function () {
            ...
            this.options.uploadTemplate = window.tmpl('s-plugin-syrattach-template-upload');
            this.options.downloadTemplate = window.tmpl('s-plugin-syrattach-template-download');
        },
        ...
        _initDialog: function() {
            var that = this;
            that.dialog = $('#s-plugin-syrattach-uploader');
