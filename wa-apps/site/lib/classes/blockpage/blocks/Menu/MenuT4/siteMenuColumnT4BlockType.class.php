...
class siteMenuColumnT4BlockType extends siteBlockType
{
    ...
    public function getExampleBlockData()
    {
        ...
        $card_props = array();
        $card_props[$this->elements['main']] = ['margin-bottom' => "m-b-a", 'margin-left' => "m-l-a", 'margin-right' => "m-r-a", 'margin-top' => "m-t-a", 'padding-top' => "p-t-0", 'padding-bottom' => "p-b-0", 'padding-left' => "p-l-clm", 'padding-right' => "p-r-clm", 'visibility' => "d-n-tb d-n-mb"];
