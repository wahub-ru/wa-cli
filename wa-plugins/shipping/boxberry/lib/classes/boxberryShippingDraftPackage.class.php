    ...
    protected function sendCreateDraftRequest($data)
    {
        ...
        if (!$error) {
            ...
            if ($api_manager->getErrors()) {
                $result['view_data'] = $this->bxb->_w('Error during automatic shipment creation. Please create a shipment manually in your personal account on the Yandex Delivery (Boxberry) website. See detailed error-related information in log file <em>wa-log/wa-plugins/shipping/boxberry/api_requests.log</em>.');
            }
        }
